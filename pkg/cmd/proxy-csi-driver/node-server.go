...
func NewNodeServerCommand(streams genericiooptions.IOStreams) *cobra.Command {
...
func (o *NodeServerOptions) Run(ctx context.Context, streams genericiooptions.IOStreams, cmd *cobra.Command) error {
	return o.run(ctx, streams)
}

func (o *NodeServerOptions) run(ctx context.Context, streams genericiooptions.IOStreams) error {
	var err error
