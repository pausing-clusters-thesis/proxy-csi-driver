...
func NewControllerServerCommand(streams genericiooptions.IOStreams) *cobra.Command {
...
func (o *ControllerServerOptions) Run(ctx context.Context, streams genericiooptions.IOStreams, cmd *cobra.Command) error {
	return o.run(ctx, streams)
}

func (o *ControllerServerOptions) run(ctx context.Context, streams genericiooptions.IOStreams) error {
	// Attacher-detacher
