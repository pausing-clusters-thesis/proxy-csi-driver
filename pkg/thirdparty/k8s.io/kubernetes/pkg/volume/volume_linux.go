...
import (
	...
	"github.com/pausing-clusters-thesis/proxy-csi-driver/pkg/thirdparty/k8s.io/kubernetes/pkg/volume/util/types"
...
// TODO: I removed Mounter interface in these func parameters and only passed on readonly, look into making this nicer - we are using MounterArgs anyway, maybe we can reuse some kubelet code

// SetVolumeOwnership modifies the given volume to be owned by
// fsGroup, and sets SetGid so that newly created files are owned by
// fsGroup. If fsGroup is nil nothing is done.
func SetVolumeOwnership(dir string, fsGroup *int64, fsGroupChangePolicy *v1.PodFSGroupChangePolicy, completeFunc func(types.CompleteFuncParam), readOnly bool) error {
	if fsGroup == nil {
		return nil
	}
	...
	if skipPermissionChange(dir, fsGroup, fsGroupChangePolicy, readOnly) {
...
func skipPermissionChange(dir string, fsGroup *int64, fsGroupChangePolicy *v1.PodFSGroupChangePolicy, readOnly bool) bool {
	...
	return !requiresPermissionChange(dir, fsGroup, readOnly)
}
